...
display: inline; 
  ...
  jQuery(document).ready(function($){
    ...
    if(unsaved) return '<?php esc_html_e('Changes you made may not be saved','wp-hubspot-woocommerce'); ?>';
});
          // Tooltips
  var tiptip_args = {
  'attribute' : 'data-tip',
  ...
  $(this).text('<?php esc_html_e('Show Key','wp-hubspot-woocommerce') ?>');  
  $(this).removeClass('vx_hidden');
  key.attr('type','password');  
  }else{
  $(this).text('<?php esc_html_e('Hide Key','wp-hubspot-woocommerce') ?>');  
