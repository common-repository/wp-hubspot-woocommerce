...
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('Data Sent','wp-hubspot-woocommerce') ?></span></div>
...
<?php
      ...
      ?>
  <div class="vx_error"><i class="fa fa-warning"></i> <?php esc_html_e('Nothing Posted to HubSpot','wp-hubspot-woocommerce');?></div>      
      <?php
  }
?>
</div></div>
...
if(is_array($response) && count($response)>0){
      ...
      ?>
        <div class="crm_panel crm_panel_50">
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('HubSpot Response','wp-hubspot-woocommerce'); ?></span></div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn fa-minus" title="<?php esc_html_e('Expand / Collapse','wp-hubspot-woocommerce'); ?>"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php esc_html_e('More Detail','wp-hubspot-woocommerce') ?></span></div>
<div class="crm_btn_div"><i class="fa crm_toggle_btn fa-minus" title="<?php esc_html_e('Expand / Collapse','wp-hubspot-woocommerce'); ?>"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
<?php
    if($log['feed_id']!=""){
?>
<a href="<?php echo esc_url(add_query_arg(array('post'=>$log['feed_id'],'action'=>'edit'), admin_url('post.php'))); ?>" title="<?php esc_html_e('Edit Feed','wp-hubspot-woocommerce') ?>" class="button"><i class="fa fa-edit"></i> <?php esc_html_e('Edit Feed','wp-hubspot-woocommerce') ?></a>
<?php
    }
?>
<a href="<?php echo esc_url(admin_url( 'admin.php?page='.$this->id.'_log&id='.$log['id'])); ?>" title="<?php esc_html_e('Open in New Window','wp-hubspot-woocommerce') ?>" target="_blank" class="button"><i class="fa fa-external-link"></i> <?php esc_html_e('Open in New Window','wp-hubspot-woocommerce') ?></a>
<a href="#" class="button vx_close_detail" title="<?php esc_html_e('Close','wp-hubspot-woocommerce') ?>"><i class="fa fa-times"></i> <?php esc_html_e('Close','wp-hubspot-woocommerce') ?></a>
