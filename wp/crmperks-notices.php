...
if( !class_exists( 'vx_crmperks_notice_vxc_hubspot' )):
class vx_crmperks_notice_vxc_hubspot extends vxc_hubspot{
public $plugin_url="https://www.crmperks.com";
public $review_link='https://wordpress.org/support/plugin/woo-hubspotforce-plugin-crm-perks/reviews/?filter=5#new-post';
...
<p><i class="fa fa-check"></i> Add WooCommerce Order Items as Products to Hubspot Deals.</p>
<p><i class="fa fa-check"></i> Hubspot custom fields.</p>
<p><i class="fa fa-check"></i> Add HubSpot Contact to Deal, Ticket, Task, Company.</p>
<p><i class="fa fa-check"></i> Hubspot Phone Number fields.</p>
<p><i class="fa fa-check"></i> Send WooCommerce Orders in bulk to Hubspot.</p>
<p><i class="fa fa-check"></i> Add a Contact to lists and workflows in Hubspot CRM.</p>
<p><i class="fa fa-check"></i> Assign owner to any object(Contact, Deal, Company etc) in Hubspot CRM.</p>
<p><i class="fa fa-check"></i> Update deals and tickets in HubSpot.</p>
<p><i class="fa fa-check"></i> Set Ticket Status , Deals stage and Status in Hubspot CRM.</p>
...
// $time=time(); $install_time['review_closed']='';
 if(!empty($install_time) && is_array($install_time) && !empty($install_time['time']) && empty($install_time['review_closed'])){ 
  ...
  <p><?php echo sprintf(__( 'You\'ve been using WooCommerce Hubspot Plugin for some time now; we hope you love it!.%s If you do, please %s leave us a %s rating on WordPress.org%s to help us spread the word and boost our motivation.','contact-form-entries'),'<br/>','<a href="'.$this->review_link.'" target="_blank" rel="noopener noreferrer">','&#9733;&#9733;&#9733;&#9733;&#9733;','</a>'); ?></p>
...
<p><b><a href="https://wordpress.org/plugins/gf-hubspotforce-crmperks/" target="_blank">Gravity Forms Hubspot Plugin</a></b> allows you to quickly integrate Gravity forms entries with Hubspot CRM.</p>
...
new vx_crmperks_notice_vxc_hubspot();
endif;
